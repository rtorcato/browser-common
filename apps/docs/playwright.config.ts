...
/**
 * Playwright config for the browser-common docs site.
 *
 ...
 * - Two projects: mobile (Pixel 7) and desktop (1280x720). Most of the bugs
...
const PORT = 3000
const BASE_URL = `http://localhost:${PORT}/browser-common/`
