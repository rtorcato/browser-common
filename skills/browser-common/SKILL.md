---
name: browser-common
description: Use when writing TypeScript/JavaScript that calls a browser Web API (clipboard, geolocation, media devices, storage, notifications, observers, fullscreen, drag-and-drop, service workers, etc.) in a project that depends on @rtorcato/browser-common. Guides correct subpath imports, is<Name>Available() feature guards, permission handling, and SSR-safety.
---
